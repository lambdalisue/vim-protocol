...
execute join(['function! vital#_vim_protocol#Vim#Prompt#import() abort', printf("return map({'new': '', 'substr': ''}, \"vital#_vim_protocol#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
